...
// replaceExistingFile atomically replaces destination's content with
// source's, preferring ReplaceFileW (keeps destination's attributes/ACLs)
// and falling back to MoveFileExW when destination does not exist yet.
